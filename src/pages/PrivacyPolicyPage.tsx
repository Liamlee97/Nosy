...
export default function PrivacyPolicyPage() {
    return (
        <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-slate-950">
            <SEO
                title="Privacy Policy - Nosy"
                description="Privacy Policy for Nosy - Learn how we collect, use, and protect your information."
                type="website"
                name="Nosy"
            />
            <Header />
            <main className="flex-grow container mx-auto px-4 py-8 max-w-4xl">
                <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm p-8 md:p-12">
                    ...
                    <div className="prose prose-blue max-w-none dark:prose-invert">
                        <p>
                            At Nosy, one of our main priorities is the privacy of our visitors.
                            This Privacy Policy document contains types of information that is collected and recorded by Nosy and how we use it.
                        </p>
                        ...
                        <h2>Log Files</h2>
                        <p>
                            Nosy follows a standard procedure of using log files. These files log visitors when they visit websites.
                        ...
                        <p>
                            Like any other website, Nosy uses 'cookies'. These cookies are used to store information including visitors' preferences,
                        ...
                        <p>
                            You may consult this list to find the Privacy Policy for each of the advertising partners of Nosy.
                        </p>

                        <p>
                            Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in their
                            respective advertisements and links that appear on Nosy, which are sent directly to users' browser. They automatically
                        ...
                        <p>
                            Note that Nosy has no access to or control over these cookies that are used by third-party advertisers.
                        </p>

                        <h2>Third Party Privacy Policies</h2>
                        <p>
                            Nosy's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective
                        ...
                        <p>
                            Nosy does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that
                        ...
                        <p>
                            ...
                            information that they shared and/or collect in Nosy. This policy is not applicable to any information collected offline
