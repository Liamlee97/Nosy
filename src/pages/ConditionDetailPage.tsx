          ...
          <Card className="dark:bg-slate-900 dark:border-slate-800">
            ...
            <CardContent>
              <ul className="space-y-2">
                ...
                )) || <p className="text-sm text-gray-500 italic">No specific risk factors listed.</p>}
              </ul>
            </CardContent>
          </Card>
          ...
          <Card className="dark:bg-slate-900 dark:border-slate-800">
            ...
            <CardContent>
              <ul className="space-y-2">
                ...
                )) || <p className="text-sm text-gray-500 italic">Consult a doctor if symptoms persist.</p>}
              </ul>
            </CardContent>
          </Card>
        </div>
                  ...
                  {condition.sources.map((source, index) => (
                    <li key={index} className="flex items-start">
                      ...
                      <a
                        ...
                        className="text-blue-600 hover:underline hover:text-blue-800 transition-colors dark:text-blue-400 dark:hover:text-blue-300"
                      >
                        {source.title}
                      </a>
                    </li>
